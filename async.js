...
//call async and then clause to run a function; 
    //I don't understand why it needs to be written this way, could param anything?
    chase().then(function(param){
        console.log(param[2])});
//consol log 'loser' or 3rd position in array. loser=false bc loser=runner#=false
